 ...
 * 2.根据 second * sample 可以知道采样数【帧数】
 * 3.根据 fileID 可以获取属性 kAudioFilePropertyPacketSizeUpperBound 知道最大的packet大小
 * 4.根据 AudioStreamBasicDescription 可知CBR下 时间段内的packet数 同时计算buffer大小
 * 5.校验保证每次buffer大小至少有一个完整packet 上下界校验
 */
